...
namespace RPG.Saving
{
    ...
    {
        private const string m_SaveFileExtension = ".json";
        ...
        public IEnumerable<string> ListSaves()
        {
            ...
            {
                if (Path.GetExtension(path) == m_SaveFileExtension)
                {
        ...
        {
            return Path.Combine(Application.persistentDataPath, saveFile + m_SaveFileExtension);
        }
    }
}
